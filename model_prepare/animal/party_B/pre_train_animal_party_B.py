'''
准备预训练模型 
refcode: https://www.kaggle.com/code/gpiosenka/extinction-f1-score-92/notebook
'''
import pandas as pd
import os
...
def start_train():
    # 加载数据
    train_csv_path = "/data/mml/overlap_v2_datasets/animal/party_B/dataset_split/train.csv"
    val_csv_path = "/data/mml/overlap_v2_datasets/animal/party_B/dataset_split/val.csv"
    ...
    # 获得batches
    classes = getClasses("/data/mml/overlap_v2_datasets/animal/party_B/dataset_split/train")
    ...
    # 加载base_model
    base_model = load_model("/data/mml/overlap_v2_datasets/animal/party_B/models/standard_base_model/base_model_Xception_150_150.h5")
    ...
    # 保存搭建好的模型结构
    model.save("/data/mml/overlap_v2_datasets/animal/party_B/models/model_struct/Xception.h5")
    # 设置检查点
    saved_dir_path = "/data/mml/overlap_v2_datasets/animal/party_B/models/model_weights"
