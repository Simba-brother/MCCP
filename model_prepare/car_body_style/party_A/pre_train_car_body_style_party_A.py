'''
准备预训练模型 
refcode: https://www.kaggle.com/code/piotrcichacki/carbodystyleclassification
'''
import pandas as pd
...
def start_train():
    # 加载数据
    train_csv_path = "/data/mml/overlap_v2_datasets/car_body_style/party_A/dataset_split/train.csv"
    val_csv_path = "/data/mml/overlap_v2_datasets/car_body_style/party_A/dataset_split/val.csv"
    ...
    # 获得batches
    classes = getClasses("/data/mml/overlap_v2_datasets/car_body_style/party_A/dataset_split/train")
    ...
    # 加载base_model
    base_model = load_model("/data/mml/overlap_v2_datasets/car_body_style/party_A/models/standard_base_model/base_model_Xception.h5")
    x=base_model.output
    ...
    x = Dense(128, 
            ...
            activation='relu', name = "party_A_Dense_1"
            )(x)
    x=Dropout(rate=.45, seed=123, name = "party_A_Dropout_1")(x)        
    output=Dense(7, activation='softmax', name = "party_A_Dense_2")(x)
    ...
    # 保存搭建好的模型结构
    model.save("/data/mml/overlap_v2_datasets/car_body_style/party_A/models/model_struct/Xception_new.h5")
    # 设置检查点
    saved_dir_path = "/data/mml/overlap_v2_datasets/car_body_style/party_A/models/model_weights"
    ...
    history = model.fit(train_batches,
                    ...
                    epochs=50, 
                    callbacks=[learning_rate_reduction, checkpointer], #[lr_scheduler, early_stopping, learning_rate_reduction, ], 
