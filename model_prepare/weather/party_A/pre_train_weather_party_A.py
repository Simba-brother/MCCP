'''
准备预训练模型 
refcode: https://www.kaggle.com/datasets/jagadeesh23/weather-classification
'''
import pandas as pd
import os
...
def start_train():
    # 加载数据
    train_csv_path = "/data/mml/overlap_v2_datasets/weather/party_A/dataset_split/train.csv"
    val_csv_path = "/data/mml/overlap_v2_datasets/weather/party_A/dataset_split/val.csv"
    ...
    # 获得batches
    classes = getClasses("/data/mml/overlap_v2_datasets/weather/party_A/dataset_split/train")
    ...
    pre_trained_model = load_model("/data/mml/overlap_v2_datasets/weather/party_A/models/standard_base_model/base_model_Xception_100_100.h5")  # 可能用party_B 的 base model效果会好
    ...
    # 保存搭建好的模型结构
    model.save("/data/mml/overlap_v2_datasets/weather/party_A/models/model_struct/vgg19.h5")
    # 设置检查点
    saved_dir_path = "/data/mml/overlap_v2_datasets/weather/party_A/models/model_weights"
