...
def start_train():
    # 加载数据
    train_csv_path = "/data/mml/overlap_v2_datasets/Fruit/party_B/dataset_split/train.csv"
    val_csv_path = "/data/mml/overlap_v2_datasets/Fruit/party_B/dataset_split/val.csv"
    ...
    # 获得batches
    classes = getClasses("/data/mml/overlap_v2_datasets/Fruit/party_B/dataset_split/train")
    ...
    # 加载base_model
    pre_trained_model = load_model("/data/mml/overlap_v2_datasets/Fruit/party_B/models/standard_base_model/base_model_Xception.h5")
    ...
    # 保存构建的模型结构
    model.save("/data/mml/overlap_v2_datasets/Fruit/party_B/models/model_struct/Xception.h5")
    # 设置检查点
    saved_dir_path = "/data/mml/overlap_v2_datasets/Fruit/party_B/models/model_weights"
