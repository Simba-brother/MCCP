...
flower_2_config = {
    ...
    "merged_unique_df":"/data/mml/overlap_v2_datasets/flower_2/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data/mml/overlap_v2_datasets/flower_2/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data/mml/overlap_v2_datasets/flower_2/party_A/dataset_split/val.csv",
    "df_train_party_A_path":"/data/mml/overlap_v2_datasets/flower_2/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data/mml/overlap_v2_datasets/flower_2/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data/mml/overlap_v2_datasets/flower_2/party_B/dataset_split/train.csv",
...
food_config = {
    ...
    "merged_unique_df":"/data/mml/overlap_v2_datasets/food/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data/mml/overlap_v2_datasets/food/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data/mml/overlap_v2_datasets/food/party_A/dataset_split/val.csv",
    "df_train_party_A_path":"/data/mml/overlap_v2_datasets/food/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data/mml/overlap_v2_datasets/food/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data/mml/overlap_v2_datasets/food/party_B/dataset_split/train.csv",
...
fruit_config = {
    ...
    "merged_unique_df":"/data/mml/overlap_v2_datasets/Fruit/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data/mml/overlap_v2_datasets/Fruit/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data/mml/overlap_v2_datasets/Fruit/party_A/dataset_split/val.csv",
    "df_train_party_A_path":"/data/mml/overlap_v2_datasets/Fruit/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data/mml/overlap_v2_datasets/Fruit/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data/mml/overlap_v2_datasets/Fruit/party_B/dataset_split/train.csv",
...
sport_config = {
    ...
    "merged_unique_df":"/data/mml/overlap_v2_datasets/sport/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data/mml/overlap_v2_datasets/sport/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data/mml/overlap_v2_datasets/sport/party_A/dataset_split/val.csv",
    "df_train_party_A_path":"/data/mml/overlap_v2_datasets/sport/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data/mml/overlap_v2_datasets/sport/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data/mml/overlap_v2_datasets/sport/party_B/dataset_split/train.csv",
    "generator_A":ImageDataGenerator(horizontal_flip=True,rotation_range=20, width_shift_range=.2, height_shift_range=.2, zoom_range=.2),
...
weather_config = {
    ...
    "merged_unique_df":"/data/mml/overlap_v2_datasets/weather/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data/mml/overlap_v2_datasets/weather/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data/mml/overlap_v2_datasets/weather/party_A/dataset_split/val.csv",
    "df_train_party_A_path":"/data/mml/overlap_v2_datasets/weather/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data/mml/overlap_v2_datasets/weather/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data/mml/overlap_v2_datasets/weather/party_B/dataset_split/train.csv",
...
animal_config = {
    ...
    "merged_unique_df":"/data/mml/overlap_v2_datasets/animal/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data/mml/overlap_v2_datasets/animal/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data/mml/overlap_v2_datasets/animal/party_A/dataset_split/val.csv",
    "df_train_party_A_path":"/data/mml/overlap_v2_datasets/animal/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data/mml/overlap_v2_datasets/animal/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data/mml/overlap_v2_datasets/animal/party_B/dataset_split/train.csv",
    "generator_A":ImageDataGenerator(rescale=1./255,horizontal_flip=True,width_shift_range=0.15,height_shift_range=0.15,rotation_range=5,zoom_range=0.15),
    "generator_B":ImageDataGenerator(rescale=1./255),
    "generator_A_test":ImageDataGenerator(rescale=1./255),
    "generator_B_test":ImageDataGenerator(rescale=1./255),
...
animal_2_config = {
    ...
    "merged_unique_df":"/data/mml/overlap_v2_datasets/animal_2/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data/mml/overlap_v2_datasets/animal_2/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data/mml/overlap_v2_datasets/animal_2/party_A/dataset_split/val.csv",
    "df_train_party_A_path":"/data/mml/overlap_v2_datasets/animal_2/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data/mml/overlap_v2_datasets/animal_2/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data/mml/overlap_v2_datasets/animal_2/party_B/dataset_split/train.csv",
...
animal_3_config = {
    ...
    "merged_unique_df":"/data/mml/overlap_v2_datasets/animal_3/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data/mml/overlap_v2_datasets/animal_3/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data/mml/overlap_v2_datasets/animal_3/party_A/dataset_split/val.csv",
    "df_train_party_A_path":"/data/mml/overlap_v2_datasets/animal_3/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data/mml/overlap_v2_datasets/animal_3/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data/mml/overlap_v2_datasets/animal_3/party_B/dataset_split/train.csv",
