...
项目数据集配置文件
'''
exp_dir = "/data2/mml/overlap_v2_datasets/"
car_body_style_config = {
    ...
    "merged_train_df":"/data2/mml/overlap_v2_datasets/car_body_style/merged_data/train/merged_df.csv",
    "merged_unique_df":"/data2/mml/overlap_v2_datasets/car_body_style/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data2/mml/overlap_v2_datasets/car_body_style/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data2/mml/overlap_v2_datasets/car_body_style/party_A/dataset_split/val.csv",
    "df_A_val_overlap":"/data2/mml/overlap_v2_datasets/car_body_style/party_A/dataset_split/val_overlap.csv",
    "df_B_val_overlap":"/data2/mml/overlap_v2_datasets/car_body_style/party_B/dataset_split/val_overlap.csv",
    "df_train_party_A_path":"/data2/mml/overlap_v2_datasets/car_body_style/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data2/mml/overlap_v2_datasets/car_body_style/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data2/mml/overlap_v2_datasets/car_body_style/party_B/dataset_split/train.csv",
    ...
    "dataset_B_train_path":"/data2/mml/overlap_v2_datasets/car_body_style/party_B/dataset_split/train",
    "sampled_common_path":"exp_data/car_body_style/sampling/percent/random",
...
flower_2_config = {
    ...
    "merged_df_path":"/data2/mml/overlap_v2_datasets/flower_2/merged_data/test/merged_df.csv",
    "merged_train_df":"/data2/mml/overlap_v2_datasets/flower_2/merged_data/train/merged_df.csv",
    "merged_unique_df":"/data2/mml/overlap_v2_datasets/flower_2/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data2/mml/overlap_v2_datasets/flower_2/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data2/mml/overlap_v2_datasets/flower_2/party_A/dataset_split/val.csv",
    "df_A_val_overlap":"/data2/mml/overlap_v2_datasets/flower_2/party_A/dataset_split/val_overlap.csv",
    "df_B_val_overlap":"/data2/mml/overlap_v2_datasets/flower_2/party_B/dataset_split/val_overlap.csv",
    "df_train_party_A_path":"/data2/mml/overlap_v2_datasets/flower_2/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data2/mml/overlap_v2_datasets/flower_2/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data2/mml/overlap_v2_datasets/flower_2/party_B/dataset_split/train.csv",
    ...
    "dataset_B_train_path":"/data2/mml/overlap_v2_datasets/flower_2/party_B/dataset_split/train",
    "merged_train_df":"/data2/mml/overlap_v2_datasets/flower_2/merged_data/train/merged_df.csv",
    "sampled_common_path":"exp_data/flower_2/sampling/percent/random",
...
food_config = {
    "dataset_name":"food",
    "merged_df_path":"/data2/mml/overlap_v2_datasets/food/merged_data/test/merged_df.csv",
    "merged_train_df":"/data2/mml/overlap_v2_datasets/food/merged_data/train/merged_df.csv",
    "merged_unique_df":"/data2/mml/overlap_v2_datasets/food/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data2/mml/overlap_v2_datasets/food/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data2/mml/overlap_v2_datasets/food/party_A/dataset_split/val.csv",
    "df_train_party_A_path":"/data2/mml/overlap_v2_datasets/food/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data2/mml/overlap_v2_datasets/food/party_B/dataset_split/val.csv",
    "df_A_val_overlap":"/data2/mml/overlap_v2_datasets/food/party_A/dataset_split/val_overlap.csv",
    "df_B_val_overlap":"/data2/mml/overlap_v2_datasets/food/party_B/dataset_split/val_overlap.csv",
    "df_train_party_B_path":"/data2/mml/overlap_v2_datasets/food/party_B/dataset_split/train.csv",
    ...
    "dataset_B_train_path":"/data2/mml/overlap_v2_datasets/food/party_B/dataset_split/train",
    "sampled_common_path":"exp_data/food/sampling/percent/random",
...
fruit_config = {
    "dataset_name":"Fruit",
    "merged_df_path":"/data2/mml/overlap_v2_datasets/Fruit/merged_data/test/merged_df.csv",
    "merged_train_df":"/data2/mml/overlap_v2_datasets/Fruit/merged_data/train/merged_df.csv",
    "merged_unique_df":"/data2/mml/overlap_v2_datasets/Fruit/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data2/mml/overlap_v2_datasets/Fruit/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data2/mml/overlap_v2_datasets/Fruit/party_A/dataset_split/val.csv",
    "df_A_val_overlap":"/data2/mml/overlap_v2_datasets/Fruit/party_A/dataset_split/val_overlap.csv",
    "df_B_val_overlap":"/data2/mml/overlap_v2_datasets/Fruit/party_B/dataset_split/val_overlap.csv",
    "df_train_party_A_path":"/data2/mml/overlap_v2_datasets/Fruit/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data2/mml/overlap_v2_datasets/Fruit/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data2/mml/overlap_v2_datasets/Fruit/party_B/dataset_split/train.csv",
    ...
    "dataset_B_train_path":"/data2/mml/overlap_v2_datasets/Fruit/party_B/dataset_split/train",
    "sampled_common_path":"exp_data/Fruit/sampling/percent/random",
...
sport_config = {
    "dataset_name":"sport",
    "merged_df_path":"/data2/mml/overlap_v2_datasets/sport/merged_data/test/merged_df.csv",
    "merged_train_df":"/data2/mml/overlap_v2_datasets/sport/merged_data/train/merged_df.csv",
    "merged_unique_df":"/data2/mml/overlap_v2_datasets/sport/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data2/mml/overlap_v2_datasets/sport/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data2/mml/overlap_v2_datasets/sport/party_A/dataset_split/val.csv",
    "df_A_val_overlap":"/data2/mml/overlap_v2_datasets/sport/party_A/dataset_split/val_overlap.csv",
    "df_B_val_overlap":"/data2/mml/overlap_v2_datasets/sport/party_B/dataset_split/val_overlap.csv",
    "df_train_party_A_path":"/data2/mml/overlap_v2_datasets/sport/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data2/mml/overlap_v2_datasets/sport/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data2/mml/overlap_v2_datasets/sport/party_B/dataset_split/train.csv",
    "generator_A":ImageDataGenerator(horizontal_flip=True,rotation_range=20, width_shift_range=.2, height_shift_range=.2, zoom_range=.2),
    ...
    "dataset_B_train_path":"/data2/mml/overlap_v2_datasets/sport/party_B/dataset_split/train",
    "sampled_common_path":"exp_data/sport/sampling/percent/random",
...
weather_config = {
    ...
    "merged_df_path":"/data2/mml/overlap_v2_datasets/weather/merged_data/test/merged_df.csv",
    "merged_train_df":"/data2/mml/overlap_v2_datasets/weather/merged_data/train/merged_df.csv",
    "merged_unique_df":"/data2/mml/overlap_v2_datasets/weather/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data2/mml/overlap_v2_datasets/weather/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data2/mml/overlap_v2_datasets/weather/party_A/dataset_split/val.csv",
    "df_A_val_overlap":"/data2/mml/overlap_v2_datasets/weather/party_A/dataset_split/val_overlap.csv",
    "df_B_val_overlap":"/data2/mml/overlap_v2_datasets/weather/party_B/dataset_split/val_overlap.csv",
    "df_train_party_A_path":"/data2/mml/overlap_v2_datasets/weather/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data2/mml/overlap_v2_datasets/weather/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data2/mml/overlap_v2_datasets/weather/party_B/dataset_split/train.csv",
    ...
    "dataset_B_train_path":"/data2/mml/overlap_v2_datasets/weather/party_B/dataset_split/train",
    "sampled_common_path":"exp_data/weather/sampling/percent/random",
...
animal_config = {
    "dataset_name":"animal",
    "merged_df_path":"/data2/mml/overlap_v2_datasets/animal/merged_data/test/merged_df.csv",
    "merged_train_df":"/data2/mml/overlap_v2_datasets/animal/merged_data/train/merged_df.csv",
    "merged_unique_df":"/data2/mml/overlap_v2_datasets/animal/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data2/mml/overlap_v2_datasets/animal/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data2/mml/overlap_v2_datasets/animal/party_A/dataset_split/val.csv",
    "df_A_val_overlap":"/data2/mml/overlap_v2_datasets/animal/party_A/dataset_split/val_overlap.csv",
    "df_B_val_overlap":"/data2/mml/overlap_v2_datasets/animal/party_B/dataset_split/val_overlap.csv",
    "df_train_party_A_path":"/data2/mml/overlap_v2_datasets/animal/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data2/mml/overlap_v2_datasets/animal/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data2/mml/overlap_v2_datasets/animal/party_B/dataset_split/train.csv",
    "generator_A":ImageDataGenerator(rescale=1./255,horizontal_flip=True,width_shift_range=0.15,height_shift_range=0.15,rotation_range=5,zoom_range=0.15),
    "generator_B":ImageDataGenerator(rescale=1./255),
    "generator_A_test":ImageDataGenerator(rescale=1./255),
    "generator_B_test":ImageDataGenerator(rescale=1./255),
    ...
    "dataset_B_train_path":"/data2/mml/overlap_v2_datasets/animal/party_B/dataset_split/train",
    "sampled_common_path":"exp_data/animal/sampling/percent/random",
...
animal_2_config = {
    ...
    "merged_df_path":"/data2/mml/overlap_v2_datasets/animal_2/merged_data/test/merged_df.csv",
    "merged_train_df":"/data2/mml/overlap_v2_datasets/animal_2/merged_data/train/merged_df.csv",
    "merged_unique_df":"/data2/mml/overlap_v2_datasets/animal_2/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data2/mml/overlap_v2_datasets/animal_2/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data2/mml/overlap_v2_datasets/animal_2/party_A/dataset_split/val.csv",
    "df_A_val_overlap":"/data2/mml/overlap_v2_datasets/animal_2/party_A/dataset_split/val_overlap.csv",
    "df_B_val_overlap":"/data2/mml/overlap_v2_datasets/animal_2/party_B/dataset_split/val_overlap.csv",
    "df_train_party_A_path":"/data2/mml/overlap_v2_datasets/animal_2/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data2/mml/overlap_v2_datasets/animal_2/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data2/mml/overlap_v2_datasets/animal_2/party_B/dataset_split/train.csv",
    ...
    "dataset_B_train_path":"/data2/mml/overlap_v2_datasets/animal_2/party_B/dataset_split/train",
    "sampled_common_path":"exp_data/animal_2/sampling/percent/random",
...
animal_3_config = {
    ...
    "merged_df_path":"/data2/mml/overlap_v2_datasets/animal_3/merged_data/test/merged_df.csv",
    "merged_train_df":"/data2/mml/overlap_v2_datasets/animal_3/merged_data/train/merged_df.csv",
    "merged_unique_df":"/data2/mml/overlap_v2_datasets/animal_3/merged_data/test/merged_df_unique.csv",
    "merged_overlap_df":"/data2/mml/overlap_v2_datasets/animal_3/merged_data/test/merged_df_overlap.csv",
    "df_eval_party_A_path":"/data2/mml/overlap_v2_datasets/animal_3/party_A/dataset_split/val.csv",
    "df_A_val_overlap":"/data2/mml/overlap_v2_datasets/animal_3/party_A/dataset_split/val_overlap.csv",
    "df_B_val_overlap":"/data2/mml/overlap_v2_datasets/animal_3/party_B/dataset_split/val_overlap.csv",
    "df_train_party_A_path":"/data2/mml/overlap_v2_datasets/animal_3/party_A/dataset_split/train.csv",
    "df_eval_party_B_path":"/data2/mml/overlap_v2_datasets/animal_3/party_B/dataset_split/val.csv",
    "df_train_party_B_path":"/data2/mml/overlap_v2_datasets/animal_3/party_B/dataset_split/train.csv",
    ...
    "dataset_B_train_path":"/data2/mml/overlap_v2_datasets/animal_3/party_B/dataset_split/train",
    "sampled_common_path":"exp_data/animal_3/sampling/percent/random",
